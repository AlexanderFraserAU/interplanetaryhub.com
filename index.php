...
<body>
  ...
  <main>
    ...
    <div id="results">
      ...
      <div class="result">
        <img src="https://p7.hiclipart.com/preview/819/333/198/video-camera-ico-icon-camera.jpg" alt="" class="file-image">
        <div class="hash-info">
          <div class="title">
          Batman - The Dark Knight Rises
          </div>
          <a class="hash" id="hashresults0" target="_blank" rel="noopener noreferrer" href="http://127.0.0.1:8080/ipfs/QmfWQHVazH6so9p27z27rr8TJSdBFGpH7hunDcaZ1EAQ2c/The.Dark.Knight.Rises.2012.720p.BluRay.x264.YIFY.mp4" onclick="linkViewModal("Batman - The Dark Knight Rises", "QmfWQHVazH6so9p27z27rr8TJSdBFGpH7hunDcaZ1EAQ2c", "The.Dark.Knight.Rises.2012.720p.BluRay.x264.YIFY.mp4", "35", "8")">QmfWQHVazH6so9p27z27rr8TJSdBFGpH7hunDcaZ1EAQ2c</a>
          <div class="author">
            Powikillyou1237512389712536,
          </div>
          <div class="time">
             4 days ago
          </div>
